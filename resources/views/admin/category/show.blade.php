                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ $category['name'] }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('spu_conf') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="spu_conf" class="form-control" name="spu_conf" rows="10" readonly>{{ $category['spu_conf'] }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('sku_conf') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="sku_conf" class="form-control" name="sku_conf" rows="10" readonly>{{ $category['sku_conf'] }}</textarea>
