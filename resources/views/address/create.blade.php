                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('address.store') }}">
                            ...
                            <div class="form-group{{ $errors->has('consignee_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="consignee_name" type="text" class="form-control" name="consignee_name" value="{{ old('consignee_name') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('consignee_mobile') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="consignee_mobile" type="tel" class="form-control" name="consignee_mobile" value="{{ old('consignee_mobile') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('province') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="province" type="text" class="form-control" name="province" value="{{ old('provincee') }}" required>
