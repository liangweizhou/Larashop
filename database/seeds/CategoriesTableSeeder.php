    ...
    public function run()
    {
        DB::table('categories')->insert([
            [
              ...
              'name' => '手机',
              'level' => 1,
              'spu_conf' => '{"brand": {"name": "品牌", "type": "enum","options": ["华为", "小米", "苹果", "其他"], "multiple_options": false, "disabled": false},"os": {"name": "操作系统", "type": "enum", "options": ["Android","iOS", "WindowsPhone", "其他"],"multiple_options": true, "disabled": false}}',
              'sku_conf' => '{"ram_size": {"name": "运行内存", "type": "intrange", "unit": "GB", "min": 1, "max": 12, "disabled": false},  "disk_size": {"name": "机身内存", "type": "intrange", "unit": "GB", "min": 8, "max": 1024, "disabled": false}, "cpu_cores": {"name": "CPU核数", "type": "enum", "options": ["单核", "双核", "四核", "八核", "十核", "其他"], "multiple_options": false, "disabled": false},  "screen_size": {"name": 屏幕尺寸", "type": "floatrange", "unit": "英寸", "min": 2.4, "max": 10.1, "disabled": false},  "battery_capacity": {"name": "电池容量", "type": "intrange", "unit": "mAh", "min": 1000, "max": 100000, "disabled": false},  "network_mode": {"name": "网络", "type": "enum", "options": ["移动4G", "电信4G", "联通4G"], "multiple_options": true, "disabled": false}}',
